...
public class CircularImageView extends AppCompatImageView {
    ...
    // Default Values
    private static final float DEFAULT_BORDER_WIDTH = 3;
    private static final float DEFAULT_SHADOW_RADIUS = 7.0f;
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        // Init Border
        if (attributes.getBoolean(R.styleable.CircularImageView_c_border, true)) {
            float defaultBorderSize = DEFAULT_BORDER_WIDTH * getContext().getResources().getDisplayMetrics().density;
            setBorderWidth(attributes.getDimension(R.styleable.CircularImageView_c_border_width, defaultBorderSize));
            setBorderColor(attributes.getColor(R.styleable.CircularImageView_c_border_color, Color.WHITE));
        }

        setBackgroundColor(attributes.getColor(R.styleable.CircularImageView_c_background_color, Color.WHITE));

        // Init Shadow
        if (attributes.getBoolean(R.styleable.CircularImageView_c_shadow, false)) {
            shadowRadius = DEFAULT_SHADOW_RADIUS;
            drawShadow(attributes.getFloat(R.styleable.CircularImageView_c_shadow_radius, shadowRadius),
                    attributes.getColor(R.styleable.CircularImageView_c_shadow_color, shadowColor));
            int shadowGravityIntValue = attributes.getInteger(R.styleable.CircularImageView_c_shadow_gravity, ShadowGravity.BOTTOM.getValue());
